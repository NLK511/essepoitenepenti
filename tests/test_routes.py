...
class RouteTests(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_dashboard_filters_by_window_and_keeps_only_proper_failures(self) -> None:
        ...
        self.assertIsNotNone(one_day_payload["dashboard_summary"]["average_profit"])
        ...
        self.assertTrue(any(series["key"] == "average_profit" for series in one_day_payload["dashboard_trends"]["series"]))
