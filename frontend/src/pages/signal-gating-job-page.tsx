            ...
            {selectedRun ? (
              <div className="stack-page">
                <section className="metrics-grid">
                  ...
                  <StatCard label="Benchmark" value={formatCount(selectedRun.benchmark_sample_count)} helper="Discarded signals graded by follow-through" tooltip="How many non-plan decision samples were benchmarked against later price movement to detect missed opportunities." tooltipTo="/docs?doc=specs-signal-gating-benchmark-spec" />
                  <StatCard label="Scoreable" value={formatCount(selectedRun.scoreable_sample_count)} helper="All labels used" tooltip="How many samples actually contributed to the objective, including plan outcomes and benchmarked discarded signals." tooltipTo="/docs?doc=specs-signal-gating-benchmark-spec" />
                </section>
