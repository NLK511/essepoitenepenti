    ...
    <>
      ...
      {data ? (
        <div className="stack-page">
          ...
          <section className="card-grid">
            <Card>
              <SectionTitle kicker="Research" title="Decision samples" subtitle="Near misses and actionable plans for calibration work." actions={<Link to="/research/signal-gating/decision-samples" className="button-secondary">Open samples</Link>} />
