...
from trade_proposer_app.api.routes.recommendation_autotune import router as recommendation_autotune_router
...
from trade_proposer_app.api.routes.support_snapshots import router as support_snapshots_router
...
router.include_router(recommendation_autotune_router)
...
router.include_router(support_snapshots_router)
