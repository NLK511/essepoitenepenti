...
from trade_proposer_app.services.news import NewsIngestionService, NewsRequestMode
    ...
    def fetch(
        ...
        *,
        ...
        if self.news_service is not None:
            news_bundle = self.news_service.fetch(ticker, start_at=start_at, end_at=end_at, request_mode=request_mode)
