...
- mounted operator evaluation/history APIs are being narrowed toward recommendation-plan evaluation and away from legacy recommendation-history endpoints, with unused legacy history/detail UI code being removed as part of the cleanup
