...
- **Evaluation truth & diagnostics**: Outcome tracking now interprets actual price action against stop-loss/take-profit levels generated by the app-native pipeline, keeping the evaluation loop anchored in this repository while migration helpers may still compare to prototype logs.
