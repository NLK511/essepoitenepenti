...
### Phase 4: Feed context into ticker setup evaluation
...
### Phase 5: Add recommendation construction and outcome tracking
Add deterministic trade-plan construction and post-trade evaluation.

### Phase 6: Retire macro/industry sentiment as the primary concept
