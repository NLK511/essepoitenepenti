...
- `decision-autotuning-plan.md`
  - development-only exploration plan for an autonomous raw tuning loop; now has a backend multi-parameter grid-search implementation, run persistence, and manual run/apply API
