...
- the legacy `/api/history` recommendation-history API is retired from the mounted operator API surface, and unused legacy history/detail frontend pages are being removed alongside recommendation-plan-first evaluation flows
