...
- the legacy `/api/history` recommendation-history API is retired from the mounted operator API surface; redesign evaluation flows are recommendation-plan-first
