...
- legacy recommendation-detail and recommendation-history surfaces are retired from active operator workflow; new proposal-generation runs are redesign-native and should be reviewed through recommendation plans and outcomes, optimization now uses recommendation-plan outcomes, and legacy recommendation persistence is now in retirement-only cleanup territory
