...
- legacy recommendation-detail and recommendation-history surfaces are retired from active operator workflow; new proposal-generation runs are redesign-native and should be reviewed through recommendation plans and outcomes, and legacy recommendation data is scheduled for deletion once optimization fully migrates to recommendation-plan outcomes
