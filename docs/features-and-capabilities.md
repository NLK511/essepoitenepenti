...
The NaiveSentiment analyzer now leans on a broader keyword and fallback heuristic set so runs with limited feeds still surface a calibrated compound score instead of silently returning zero.
