...
- legacy recommendation-detail and recommendation-history surfaces are retired from active operator workflow; historical legacy rows may still exist in storage, but new proposal-generation runs are redesign-native and should be reviewed through recommendation plans and outcomes
