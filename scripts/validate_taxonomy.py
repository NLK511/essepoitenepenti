...
def main() -> int:
    ...
    expected_paths = [TICKERS_PATH, INDUSTRIES_PATH, SECTORS_PATH, RELATIONSHIPS_PATH, EVENT_VOCAB_PATH, THEMES_PATH, MACRO_CHANNELS_PATH, TRANSMISSION_CHANNELS_PATH, TRANSMISSION_TAGS_PATH, TRANSMISSION_PRIMARY_DRIVERS_PATH, TRANSMISSION_CONFLICT_FLAGS_PATH, TRANSMISSION_BIASES_PATH, TRANSMISSION_CONTEXT_REGIMES_PATH, RELATIONSHIP_TYPES_PATH, RELATIONSHIP_TARGET_KINDS_PATH]
